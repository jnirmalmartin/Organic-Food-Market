...
<body>
    ...
    <section>
        <h2>User Registeration... <p> New Seller? <a href="seller-register.php"><font color="red">Registerhere</font></a></p></h2>
 ...
 <p>Existing user? <a href="ofm1.php" style: color"blue">Login Here</a></p>
            </form>
        </div>
    </section>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO users (Name, Age, Phone, Address, Email, Username, Password)
                VALUES ('$name', '$age', '$phone', '$address', '$email', '$username', '$password')";

        if ($conn->query($sql) === TRUE) {
            echo '<script>alert("Registered your account successfully!!")</script>';
            header("Location: userindex.php");
        } else {
            echo '<script>alert("User name already taken! please chose new username!")</script>';
